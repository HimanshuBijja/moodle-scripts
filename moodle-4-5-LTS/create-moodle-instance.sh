...
# Moodle 4.5 LTS Instance Creator Script
# Creates a new Moodle 4.5 LTS instance with Docker Compose
...
echo ""
echo "=========================================="
print_success "Moodle $MOODLE_VERSION instance is READY TO USE!"
echo "=========================================="
echo ""
